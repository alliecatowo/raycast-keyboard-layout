...
const BASIC_KEYCODES: Record<number, string> = {
  ...
  // Editing
  0x0028: "KC_ENT", 0x0029: "KC_ESC", 0x002a: "KC_BSPC",
  0x002b: "KC_TAB", 0x002c: "KC_SPC",
  // Symbols
  0x002d: "KC_MINS", 0x002e: "KC_EQL", 0x002f: "KC_LBRC",
  0x0030: "KC_RBRC", 0x0031: "KC_BSLS", 0x0033: "KC_SCLN",
  0x0034: "KC_QUOT", 0x0035: "KC_GRV", 0x0036: "KC_COMM",
  0x0037: "KC_DOT", 0x0038: "KC_SLSH",
  // Locks
  0x0039: "KC_CAPS",
  // F-keys
  ...
  // Arrows
  0x004f: "KC_RGHT", 0x0050: "KC_LEFT", 0x0051: "KC_DOWN", 0x0052: "KC_UP",
  // Numpad
  0x0053: "KC_NUM", 0x0054: "KC_PSLS", 0x0055: "KC_PAST",
  0x0056: "KC_PMNS", 0x0057: "KC_PPLS", 0x0058: "KC_PENT",
  0x0059: "KC_P1", 0x005a: "KC_P2", 0x005b: "KC_P3",
  0x005c: "KC_P4", 0x005d: "KC_P5", 0x005e: "KC_P6",
  0x005f: "KC_P7", 0x0060: "KC_P8", 0x0061: "KC_P9",
  0x0062: "KC_P0", 0x0063: "KC_PDOT",
  // Misc
  0x0065: "KC_APP",
  // Extended F-keys
  ...
  // Media / Consumer
  0x00a5: "KC_MPLY", 0x00a6: "KC_MSTP", 0x00a7: "KC_MPRV",
  0x00a8: "KC_MUTE", 0x00a9: "KC_VOLU", 0x00aa: "KC_VOLD", 0x00ab: "KC_MNXT",
  // macOS specific
  0x00d1: "KC_BRMU", 0x00d2: "KC_BRMD",
  0x00d4: "KC_MCTL", 0x00d5: "KC_LPAD",
};

// ── Shifted symbol shortcuts ─────────────────────────────

const SHIFTED_SYMBOLS: Record<number, string> = {
  0x1e: "KC_EXLM", 0x1f: "KC_AT", 0x20: "KC_HASH", 0x21: "KC_DLR",
  0x22: "KC_PERC", 0x23: "KC_CIRC", 0x24: "KC_AMPR", 0x25: "KC_ASTR",
  0x26: "KC_LPRN", 0x27: "KC_RPRN", 0x2d: "KC_UNDS", 0x2e: "KC_PLUS",
  0x2f: "KC_LCBR", 0x30: "KC_RCBR", 0x31: "KC_PIPE", 0x33: "KC_COLN",
  0x34: "KC_DQUO", 0x35: "KC_TILD", 0x36: "KC_LABK", 0x37: "KC_RABK",
  0x38: "KC_QUES",
};
...
const LIGHTING_KEYCODES: Record<number, string> = {
  // Backlight
  0x7800: "BL_ON", 0x7801: "BL_OFF", 0x7802: "BL_TOGG",
  0x7803: "BL_DEC", 0x7804: "BL_INC", 0x7805: "BL_STEP", 0x7806: "BL_BRTG",
  ...
  0x7840: "RM_ON", 0x7841: "RM_OFF", 0x7842: "RM_TOGG",
  0x7843: "RM_NEXT", 0x7844: "RM_PREV", 0x7845: "RM_HUEU",
  0x7846: "RM_HUED", 0x7847: "RM_SATU", 0x7848: "RM_SATD",
  0x7849: "RM_VALU", 0x784a: "RM_VALD", 0x784b: "RM_SPDU", 0x784c: "RM_SPDD",
};

// ── QK_QUANTUM named keycodes (0x7C00–0x7DFF) ───────────

const QUANTUM_KEYCODES: Record<number, string> = {
  0x7c00: "QK_BOOT", 0x7c01: "QK_RBT", 0x7c02: "DB_TOGG", 0x7c03: "EE_CLR",
  0x7c16: "KC_GESC",
...
export function numericKeycodeToString(keycode: number): string {
  ...
  // QK_BASIC (0x0000–0x00FF)
  if (keycode <= 0x00ff) {
    return BASIC_KEYCODES[keycode] ?? `KC_0x${keycode.toString(16).padStart(2, "0")}`;
  }
